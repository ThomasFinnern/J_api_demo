...
---------------------------------------
jsonApiView
displayList(?array $items = null) can be given a list of items, otherwise they are fetched/generated with the model 
displayItem(?array $items = null) can be given an item, otherwise it is fetched/generated with the model
