...
info: |
  ...
  Presentation slides for developers.[00.MinCode.md](00.MinCode.md)
...
Imagine a second hand books component with <br>
...
The idea is to use an external scan of the ISBN  <br>
of the book, fetch book data by other web API  <br>
...
# Web Services API plugin <h3>plg_webservices_secondhand</h3>
...
└─── secondhand.xml
```
The general folder structure is similar to each other API base structure.<br>
The file src->Extension->Secondhand.php will hold the API definition,<br>
whereas all other folders and files support the API event interception.

---
## Manifest file 'secondhand.xml'

Following is an excerpt as the content is known
```xml
...
The group (see first line) is 'webservices'.
...
We defined the table and the view
...
The plugin and two wo files (`BooksController.php`, `JsonapiView.php`) <br>
enable CRUD ACCESS over the API of joomla. <br>
