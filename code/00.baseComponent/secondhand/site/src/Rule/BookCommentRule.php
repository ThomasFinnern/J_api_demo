...
namespace Bluebox\Component\Secondhand\Site\Rule;
...
/**
 * FormRule for com_secondhand to make sure the message body contains no banned word.
 *
 * @since  1.6
 */
class SecondhandCommentRule extends FormRule
{
	/**
