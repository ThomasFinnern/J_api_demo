...
echo --- "%ExePath%php.exe" buildExtensionCmd.php -f ../../J!_api_demo/code/.buildPHP/build.tsk %OptionFile%
"%ExePath%php.exe" buildExtensionCmd.php -f ../../J!_api_demo/code/.buildPHP/build.tsk %OptionFile%
